...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000016d417ee00000000065c14d2(
...
class phpbbtemplatetwiglexer_0000000016d417ee00000000065c14d2 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b5057435a0b2532858904 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b5057435a0c1702082844 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b5057435a08e452589454 = array(
    ...
    {
        $this->initializer5b5057435a0c1702082844 && ($this->initializer5b5057435a0c1702082844->__invoke($valueHolder5b5057435a0b2532858904, $this, 'set_environment', array('env' => $env), $this->initializer5b5057435a0c1702082844) || 1) && $this->valueHolder5b5057435a0b2532858904 = $valueHolder5b5057435a0b2532858904;

        return $this->valueHolder5b5057435a0b2532858904->set_environment($env);
    }
    ...
    {
        $this->initializer5b5057435a0c1702082844 && ($this->initializer5b5057435a0c1702082844->__invoke($valueHolder5b5057435a0b2532858904, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b5057435a0c1702082844) || 1) && $this->valueHolder5b5057435a0b2532858904 = $valueHolder5b5057435a0b2532858904;

        return $this->valueHolder5b5057435a0b2532858904->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b5057435a0c1702082844 && ($this->initializer5b5057435a0c1702082844->__invoke($valueHolder5b5057435a0b2532858904, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b5057435a0c1702082844) || 1) && $this->valueHolder5b5057435a0b2532858904 = $valueHolder5b5057435a0b2532858904;

        return $this->valueHolder5b5057435a0b2532858904->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b5057435a0c1702082844 = $initializer;
    }
    ...
    {
        $this->initializer5b5057435a0c1702082844 && ($this->initializer5b5057435a0c1702082844->__invoke($valueHolder5b5057435a0b2532858904, $this, '__get', array('name' => $name), $this->initializer5b5057435a0c1702082844) || 1) && $this->valueHolder5b5057435a0b2532858904 = $valueHolder5b5057435a0b2532858904;

        if (isset(self::$publicProperties5b5057435a08e452589454[$name])) {
            return $this->valueHolder5b5057435a0b2532858904->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b5057435a0b2532858904;
    ...
    {
        $this->initializer5b5057435a0c1702082844 && ($this->initializer5b5057435a0c1702082844->__invoke($valueHolder5b5057435a0b2532858904, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b5057435a0c1702082844) || 1) && $this->valueHolder5b5057435a0b2532858904 = $valueHolder5b5057435a0b2532858904;
    ...
    {
        $this->initializer5b5057435a0c1702082844 && ($this->initializer5b5057435a0c1702082844->__invoke($valueHolder5b5057435a0b2532858904, $this, '__isset', array('name' => $name), $this->initializer5b5057435a0c1702082844) || 1) && $this->valueHolder5b5057435a0b2532858904 = $valueHolder5b5057435a0b2532858904;
    ...
    {
        $this->initializer5b5057435a0c1702082844 && ($this->initializer5b5057435a0c1702082844->__invoke($valueHolder5b5057435a0b2532858904, $this, '__unset', array('name' => $name), $this->initializer5b5057435a0c1702082844) || 1) && $this->valueHolder5b5057435a0b2532858904 = $valueHolder5b5057435a0b2532858904;
    ...
    {
        $this->initializer5b5057435a0c1702082844 && ($this->initializer5b5057435a0c1702082844->__invoke($valueHolder5b5057435a0b2532858904, $this, '__clone', array(), $this->initializer5b5057435a0c1702082844) || 1) && $this->valueHolder5b5057435a0b2532858904 = $valueHolder5b5057435a0b2532858904;

        $this->valueHolder5b5057435a0b2532858904 = clone $this->valueHolder5b5057435a0b2532858904;
    }

    public function __sleep()
    {
        $this->initializer5b5057435a0c1702082844 && ($this->initializer5b5057435a0c1702082844->__invoke($valueHolder5b5057435a0b2532858904, $this, '__sleep', array(), $this->initializer5b5057435a0c1702082844) || 1) && $this->valueHolder5b5057435a0b2532858904 = $valueHolder5b5057435a0b2532858904;

        return array('valueHolder5b5057435a0b2532858904');
    }
    ...
    {
        return $this->initializer5b5057435a0c1702082844;
    }
    ...
    {
        return $this->initializer5b5057435a0c1702082844 && ($this->initializer5b5057435a0c1702082844->__invoke($valueHolder5b5057435a0b2532858904, $this, 'initializeProxy', array(), $this->initializer5b5057435a0c1702082844) || 1) && $this->valueHolder5b5057435a0b2532858904 = $valueHolder5b5057435a0b2532858904;
    }
    ...
    {
        return null !== $this->valueHolder5b5057435a0b2532858904;
    }
    ...
    {
        return $this->valueHolder5b5057435a0b2532858904;
    }
