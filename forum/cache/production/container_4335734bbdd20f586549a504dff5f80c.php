...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000052bdb145000000004ae0d540(
...
class phpbbtemplatetwiglexer_0000000052bdb145000000004ae0d540 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b50a0117dbbf285445513 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b50a0117dbd1849897063 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b50a0117db93488483448 = array(
    ...
    {
        $this->initializer5b50a0117dbd1849897063 && ($this->initializer5b50a0117dbd1849897063->__invoke($valueHolder5b50a0117dbbf285445513, $this, 'set_environment', array('env' => $env), $this->initializer5b50a0117dbd1849897063) || 1) && $this->valueHolder5b50a0117dbbf285445513 = $valueHolder5b50a0117dbbf285445513;

        return $this->valueHolder5b50a0117dbbf285445513->set_environment($env);
    }
    ...
    {
        $this->initializer5b50a0117dbd1849897063 && ($this->initializer5b50a0117dbd1849897063->__invoke($valueHolder5b50a0117dbbf285445513, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b50a0117dbd1849897063) || 1) && $this->valueHolder5b50a0117dbbf285445513 = $valueHolder5b50a0117dbbf285445513;

        return $this->valueHolder5b50a0117dbbf285445513->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b50a0117dbd1849897063 && ($this->initializer5b50a0117dbd1849897063->__invoke($valueHolder5b50a0117dbbf285445513, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b50a0117dbd1849897063) || 1) && $this->valueHolder5b50a0117dbbf285445513 = $valueHolder5b50a0117dbbf285445513;

        return $this->valueHolder5b50a0117dbbf285445513->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b50a0117dbd1849897063 = $initializer;
    }
    ...
    {
        $this->initializer5b50a0117dbd1849897063 && ($this->initializer5b50a0117dbd1849897063->__invoke($valueHolder5b50a0117dbbf285445513, $this, '__get', array('name' => $name), $this->initializer5b50a0117dbd1849897063) || 1) && $this->valueHolder5b50a0117dbbf285445513 = $valueHolder5b50a0117dbbf285445513;

        if (isset(self::$publicProperties5b50a0117db93488483448[$name])) {
            return $this->valueHolder5b50a0117dbbf285445513->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b50a0117dbbf285445513;
    ...
    {
        $this->initializer5b50a0117dbd1849897063 && ($this->initializer5b50a0117dbd1849897063->__invoke($valueHolder5b50a0117dbbf285445513, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b50a0117dbd1849897063) || 1) && $this->valueHolder5b50a0117dbbf285445513 = $valueHolder5b50a0117dbbf285445513;
    ...
    {
        $this->initializer5b50a0117dbd1849897063 && ($this->initializer5b50a0117dbd1849897063->__invoke($valueHolder5b50a0117dbbf285445513, $this, '__isset', array('name' => $name), $this->initializer5b50a0117dbd1849897063) || 1) && $this->valueHolder5b50a0117dbbf285445513 = $valueHolder5b50a0117dbbf285445513;
    ...
    {
        $this->initializer5b50a0117dbd1849897063 && ($this->initializer5b50a0117dbd1849897063->__invoke($valueHolder5b50a0117dbbf285445513, $this, '__unset', array('name' => $name), $this->initializer5b50a0117dbd1849897063) || 1) && $this->valueHolder5b50a0117dbbf285445513 = $valueHolder5b50a0117dbbf285445513;
    ...
    {
        $this->initializer5b50a0117dbd1849897063 && ($this->initializer5b50a0117dbd1849897063->__invoke($valueHolder5b50a0117dbbf285445513, $this, '__clone', array(), $this->initializer5b50a0117dbd1849897063) || 1) && $this->valueHolder5b50a0117dbbf285445513 = $valueHolder5b50a0117dbbf285445513;

        $this->valueHolder5b50a0117dbbf285445513 = clone $this->valueHolder5b50a0117dbbf285445513;
    }

    public function __sleep()
    {
        $this->initializer5b50a0117dbd1849897063 && ($this->initializer5b50a0117dbd1849897063->__invoke($valueHolder5b50a0117dbbf285445513, $this, '__sleep', array(), $this->initializer5b50a0117dbd1849897063) || 1) && $this->valueHolder5b50a0117dbbf285445513 = $valueHolder5b50a0117dbbf285445513;

        return array('valueHolder5b50a0117dbbf285445513');
    }
    ...
    {
        return $this->initializer5b50a0117dbd1849897063;
    }
    ...
    {
        return $this->initializer5b50a0117dbd1849897063 && ($this->initializer5b50a0117dbd1849897063->__invoke($valueHolder5b50a0117dbbf285445513, $this, 'initializeProxy', array(), $this->initializer5b50a0117dbd1849897063) || 1) && $this->valueHolder5b50a0117dbbf285445513 = $valueHolder5b50a0117dbbf285445513;
    }
    ...
    {
        return null !== $this->valueHolder5b50a0117dbbf285445513;
    }
    ...
    {
        return $this->valueHolder5b50a0117dbbf285445513;
    }
